        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <ul class="main__menu">
                    ...
                    @if($pageLogin == 1)<li><a wire:click="showRegister()"  class="menu--active" >Registration</a></li>@endif
                    @if($pageRegister == 1)<li><a wire:click="showLogin()"  class="menu--active" >Login</a></li>@endif
           ...
           {{-- @if($pageLogin == 1)
            <div class="col-lg-2 text-lg-right d-none d-lg-block">
                <button wire:click="showRegister()" class="site__btn">Registration</button>
            </div>
            @endif--}}
